...
function createTicket(){
    ...
    $q = $bdd->prepare('INSERT INTO ticket (tic_titre, tic_description, tic_demandeur, tic_projet, tic_type, tic_urgence, tic_date_creation) VALUES (:titre, :description, :demandeur, :projet, :type, :urgence, :creation)');
    $q->execute(array(
        'titre' => $_POST['ticket_title'],
        'description' => $_POST['ticket_description'],
        'demandeur' => $_SESSION['loginId'],
        'projet' => $_POST['ticket_project'],
